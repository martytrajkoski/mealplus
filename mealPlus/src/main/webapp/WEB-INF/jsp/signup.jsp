    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col2row2">
                <div class="najava">
                    <p align="center">Регистрaција</p>
                </div>
                <div class="content">
                    <input type="email" class="name" placeholder="Име">
                    <input type="email" class="name" placeholder="Презиме">
                    <input type="email" class="email" placeholder="Е-пошта">
                    <input type="password" class="password" placeholder="Лозинка">
                    <input type="password" class="repassword" placeholder="Потврди лозинка">
                    <input type="submit" class="submit" value="Регистрирај се" >
                    <p>Со регистрирање се согласувате со нашите <br> Услови за Користење и Политика за Приватност</p>
                </div>
            </div>
